...
export function useCreateLog() {
  ...
  return useMutation({
    ...
    onSuccess: () => {
      // Intentionally not invalidating queries immediately to prevent spamming the backend
      // during fast simulation updates. The local state handles the real-time view.
    },
  });
}
